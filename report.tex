...
linear amplification region of the low noise amplifier.
\chapter{Transmitter's modulator}
% Describe how the output signal from t
he USB FTDI Chip is modulating the provided Voltage
...
\begin{tikzpicture}
    ...
    \node (transmit) [cell, right = 0.2cm of modulator.east] {antenna};
    \node (receive) [cell, right = 0.5cm of transmit.east] {antenna};
